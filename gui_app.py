...
# Primera parte
     ...
     def campos_pelicula(self):
         ...
         self.entry_puntacion.grid(row=4, column=2, padx=10, pady=10)
 
         self.mi_genero= tk.StringVar()
         self.entry_genero = tk.Entry(self, textvariable= self.mi_genero)
         self.entry_genero.config(width=50, font=('Times New Roman', 12))
         self.entry_genero.grid(row=5, column=2, padx=10, pady=10)
        ...
        #botones nuevo
         ...
         self.boton_guardar.grid(row=1, column=2, padx=10, pady=10)
     ...
     def tabla_peliculas(self):
         ...
         column= ('Nombre', 'Puntacion','Genero'))
         self.tabla.grid(row=6, column=1, columnspan= 4,sticky= 'nse')
         ...
         self.tabla.heading('#2', text='Puntacion')
